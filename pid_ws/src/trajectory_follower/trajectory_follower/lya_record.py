...
class TrajectoryFollower(Node):
    def __init__(self):
        ...
        self.data = pd.DataFrame(columns=["Time", "V", "Omega","X","Y","theta", "X_car", "Y_car", "theta_car", "k1", "k2", "lambda_v", "lambda_a"])
    ...
    def trajectory_callback(self, msg):
        ...
        new_row = pd.DataFrame([[current_time_str, v, omega, target_x, target_y, phi_t, current_x, current_y, current_yaw, self.lya.k1, self.lya.k2, self.lya.lambda_v, self.lya.lambda_a]],
                                columns=["Time", "V", "Omega","X","Y","theta", "X_car", "Y_car", "theta_car", "k1", "k2", "lambda_v", "lambda_a"])
