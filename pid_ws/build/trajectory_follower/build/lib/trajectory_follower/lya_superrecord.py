...
class TrajectoryFollower(Node):
    ...
    def trajectory_callback(self, msg):
        ...
        new_row = pd.DataFrame([[current_time_str, v, omega, target_x, target_y, phi_t, current_x, current_y, current_yaw]],
                                columns=["Time", "V", "Omega","X","Y","theta", "X_car", "Y_car", "theta_car"])
