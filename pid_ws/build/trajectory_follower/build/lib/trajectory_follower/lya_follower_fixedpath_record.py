...
class Follower(Node):
    ...
    def control_loop(self):
        ...
        new_row = pd.DataFrame([[current_time_str, v, omega, target_x, target_y, phi_t, current_x, current_y, current_yaw, dx, dy, LAM_V, LAM_A, K1, K2]],
                                columns=["Time", "V", "Omega","X","Y","theta", "X_current", "Y_current", "theta_current", "dx", "dy", "LAM_V", "LAM_A", "K1", "K2"])
