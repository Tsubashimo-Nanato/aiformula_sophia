...
class DataJudgmentNode(Node):
    ...
    def start_playback(self):
        ...
        if self.next_group == 'L':
            self.current_path = self.new_path_L_a
        else:
